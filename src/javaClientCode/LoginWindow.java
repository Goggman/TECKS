...
public class LoginWindow implements Window{
	...
	public Scene createScene(){
		...
		Label feed = new Label("Welcome to TECHS, please log in"); feed.setLayoutX(xBase+0); feed.setLayoutY(yBase-50);
		feed.setPrefSize(100, 100);
		TextField username = new TextField("Enter username"); username.setLayoutX(xBase+0); username.setLayoutY(yBase+0);
